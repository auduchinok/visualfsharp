...
let ``Test project1 xxx symbols`` () = 
    ...
    let xSymbolUseOpt = backgroundTypedParse1.GetSymbolUse(7, 7, Project1.lines1.[6]) |> Async.RunSynchronously
...
let ``Test file explicit parse symbols`` () = 
    ...
    let xSymbolUse2Opt = checkResults1.GetSymbolUse(7, 7, Project1.lines1.[6]) |> Async.RunSynchronously
...
let ``Test project4 T symbols`` () = 
    ...
    let tSymbolUse2 = backgroundTypedParse1.GetSymbolUse(4, 19, Project4.lines1.[3]) |> Async.RunSynchronously
    ...
    let tSymbolUse3 = backgroundTypedParse1.GetSymbolUse(4, 11, Project4.lines1.[3]) |> Async.RunSynchronously
    ...
    let uSymbolUse2 = backgroundTypedParse1.GetSymbolUse(6, 23, Project4.lines1.[5]) |> Async.RunSynchronously
...
let ``Test complete active patterns' exact ranges from uses of symbols`` () =
    ...
    let oddSymbolUse = backgroundTypedParse1.GetSymbolUse(11, 8, Project5.lines1.[10]) |> Async.RunSynchronously
    ...
    let evenSymbolUse = backgroundTypedParse1.GetSymbolUse(10, 9, Project5.lines1.[9]) |> Async.RunSynchronously
...
let ``Test partial active patterns' exact ranges from uses of symbols`` () =
    ...
    let floatSymbolUse = backgroundTypedParse1.GetSymbolUse(22, 10, Project5.lines1.[21]) |> Async.RunSynchronously
    ...
    let floatSymUseOpt = 
        backgroundTypedParse1.GetSymbolUse(14, 11, Project5.lines1.[13])
        |> Async.RunSynchronously
...
let ``Test Project10 all symbols`` () =
    ...
    let querySymbolUseOpt = 
        backgroundTypedParse1.GetSymbolUse(7, 23, Project10.lines1.[6])
        |> Async.RunSynchronously
...
let ``Test symbol uses of properties with both getters and setters`` () = 
    ...
    let getSampleSymbolUseOpt = 
        backgroundTypedParse1.GetSymbolUse(9, 20, Project24.lines1.[8])
        |> Async.RunSynchronously
...
let ``Test Project25 symbol uses of type-provided members`` () = 
    ...
    let getSampleSymbolUseOpt = 
        backgroundTypedParse1.GetSymbolUse(5, 25, Project25.lines1.[4])
        |> Async.RunSynchronously
...
let ``Test symbol uses of type-provided types`` () = 
    ...
    let getSampleSymbolUseOpt = 
        backgroundTypedParse1.GetSymbolUse(4, 26, Project25.lines1.[3])
        |> Async.RunSynchronously
...
let ``Test symbol uses of fully-qualified records`` () = 
    ...
    let getSampleSymbolUseOpt = 
        backgroundTypedParse1.GetSymbolUse(7, 11, Project25.lines1.[6])
        |> Async.RunSynchronously
...
let ``Test Project32 should be able to find sig symbols`` () =
    ...
    let sigSymbolUseOpt = sigBackgroundTypedParse1.GetSymbolUse(4, 8, Project32.lines1.[3]) |> Async.RunSynchronously
...
let ``Test Project32 should be able to find impl symbols`` () =
    ...
    let implSymbolUseOpt = implBackgroundTypedParse1.GetSymbolUse(3, 8, Project32.lines1.[2]) |> Async.RunSynchronously
