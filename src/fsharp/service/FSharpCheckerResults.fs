        ...
        ErrorScope.Protect Range.range0 
            (fun () ->
                ...
                | Some (items, denv, ctx, m) ->
                    ...
                    FSharpDeclarationListInfo.Create(infoReader,m,denv,cenv, unresolvedOnly,items,isAttributeApplication))
            (fun msg -> 
    ...
    member __.GetAllUsesOfAllSymbolsInFile(?cancellationToken: CancellationToken ) = 
        threadSafeOp
            ...
            (fun scope ->
                ...
                seq { for symbolUse in scope.ScopeSymbolUses.AllUsesOfSymbols do
